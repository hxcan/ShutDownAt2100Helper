...
public class ShutDownAt2100Manager
{
  ...
  protected Set<Long> committedTransactionIdSet=new HashSet<Long>(); //!<已提交的事务编号集合。
	...
	private void executeShutDown()
	{
      ...
      {
        showOwnStopUsingPhoneActivity(); //显示自己的停止使用手机活动
	 ...
	 * 显示自己的停止使用手机活动
	 */
	private void showOwnStopUsingPhoneActivity()
	{
      Intent launchIntent=new Intent(context, StopUsingPhoneActivity.class); //启动意图。
