...
public class PreferenceManagerUtil {
	 ...
	 */
	public static void setShutdownHour(int clientId)
	{
		Context ct = QueueMateStoreApplication.getAppContext(); //获取应用程序上下文。
	 ...
	 * @param clientId 要保存的客户端编号。
	 */
	public static void setShutdownMinute(int clientId)
	{
		Context ct = QueueMateStoreApplication.getAppContext(); //获取应用程序上下文。
		SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(ct); //获取共享配置对象。
